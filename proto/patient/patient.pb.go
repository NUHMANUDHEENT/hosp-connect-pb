...
type GetPrescriptionResponse struct {
	...
	Status       string      `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	Prescription []*GetPresc `protobuf:"bytes,2,rep,name=prescription,proto3" json:"prescription,omitempty"`
	Message      string      `protobuf:"bytes,3,opt,name=message,proto3" json:"message,omitempty"`
...
func (x *GetPrescriptionResponse) GetPrescription() []*GetPresc {
	if x != nil {
		return x.Prescription
	}
	return nil
...
var file_patient_patient_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x22, 0xa3, 0x01, 0x0a, 0x17, 0x47, 0x65, 0x74,
	...
	0x70, 0x72, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x70, 0x61, 0x74, 0x69, 0x65, 0x6e, 0x74, 0x2e, 0x47, 0x65, 0x74,
	0x50, 0x72, 0x65, 0x73, 0x63, 0x52, 0x0c, 0x70, 0x72, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74,
...
var file_patient_patient_proto_depIdxs = []int32{
	...
	16, // 4: patient.GetPrescriptionResponse.prescription:type_name -> patient.GetPresc
